...
Setup:
Start by creating a new project in sbt for your solutions.
...
C:\Windows\System32\javaw.exe -cp "%SCALA_HOME%/lib/*";"C:/Users/Rhys/.ivy2/local/default/tcparser_2.9.0-1/0.1-SNAPSHOT/jars/tcparser_2.9.0-1.jar" tcparsing.TCPFrame
...
Click "Save code"
Click "Save test"
An sbt command such as "~test-only topcoder.code.scala.SRM144_1_2" will be automatically copied to the clipboard. Switch to sbt, paste and run this command, to continuously run the tests. Clearly, it should not pass initially.
...
This has not been tested on *nix systems, although it should work. (Actually, it will probably have problems with newline characters. I'll fix this when I get the chance; in the meantime, feel free to fix it yourself and send me a pull request!)